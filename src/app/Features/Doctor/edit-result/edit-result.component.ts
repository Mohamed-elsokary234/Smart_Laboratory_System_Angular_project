...
getdeptId(e)
{
  ...
  for(let item of this.listtests)
  {
    ...
    console.log("pushed")
      console.log(item)
      //this.data.push(item.results[0].Result_value);
  ...
  this.form.controls['btnEdit'].setValue("update Results");
  // this.form.valid;
}
    //
    getpatientId(e){
...
result_id;
    editResult(){
      ...
      //
      //   this.result = new  result(this.testResults[i].result_Id , this.testResults[i].pat_Id_fk , this.testResults[i].sam_Id_fk , this.testResults[i].emp_Id_fk , this.testResults[i].test_Id_fk , this.testResults[i].Result_value);
      //   //console.log("obj  result")
      //  // console.log(result)
      //     console.log("old result id")
      //     console.log(this.patientobj.results[0].result_Id)
      //    this.resultservice.editResult(this.patientobj.results[0].result_Id,this.result);
      //
      // }
      for(let item of this.testResults)
      {
        this.result = new  result(this.result_id , item.pat_Id_fk , item.sam_Id_fk , item.emp_Id_fk , item.test_Id_fk , item.Result_value);
      //this.result=new result(item.pat_Id_fk,item.sam_Id_fk,item.emp_Id_fk,item.test_Id_fk,item.Result_value,item.result_id);
        console.log("old result id")
        console.log(this.patientobj.results[0].result_Id)
       this.resultservice.editResult(this.patientobj.results[0].result_Id,this.result);
      //  alert("ok");
